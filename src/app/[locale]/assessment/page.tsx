...
import {
  EnhancedWelcome,
  IdentityStep,
} from "@/components/assessment/enhanced-welcome";
...
const STEPS = [
  ...
  { id: "identity", title: "About You", component: IdentityStep },
  {
    ...
    component: RelationshipHistoryStep,
  },
  {
    id: "emotional-intelligence",
    title: "Emotional Profile",
    component: EmotionalIntelligenceStep,
  },
  {
    id: "values-vision",
    title: "Values & Vision",
    component: ValuesVisionStep,
  },
  {
    id: "lifestyle-compatibility",
    title: "Lifestyle & Communication",
    component: LifestyleCompatibilityStep,
  },
  {
    id: "self-reflection",
    title: "Self-Reflection",
    component: SelfReflectionStep,
  },
  ...
  useEffect(() => {
    if (isEditMode && existingProfile && !profileLoading) {
      setAssessmentData({
        ...
        hasSignificantPast: (existingProfile.relationshipHistory as any)
          ?.hasSignificantPast,
        lastRelationshipDuration: (existingProfile.relationshipHistory as any)
          ?.lastRelationshipDuration,
        timeSinceLastRelationship: (existingProfile.relationshipHistory as any)
          ?.timeSinceLastRelationship,
        keyLessonsLearned: (existingProfile.relationshipHistory as any)
          ?.keyLessonsLearned,
        healingProgress: (existingProfile.relationshipHistory as any)
          ?.healingProgress,
        relationshipHistory:
          (existingProfile.relationshipHistory as any) || undefined,
        relationshipGoals: existingProfile.relationshipGoals?.length
          ? existingProfile.relationshipGoals
          : undefined,
        relationshipReadiness:
          existingProfile.relationshipReadiness || undefined,

        // Emotional profile - flatten for component compatibility
        attachmentStyle: (existingProfile.emotionalProfile as any)
          ?.attachmentStyle,
        ...
        emotionalChallenges: (existingProfile.emotionalProfile as any)
          ?.emotionalChallenges,
        emotionalProfile:
          (existingProfile.emotionalProfile as any) || undefined,
        ...
        // Communication
        preferredCommunicationStyle:
          existingProfile.preferredCommunicationStyle || undefined,
        // Add a default communication style if missing
        communicationStyle:
          existingProfile.preferredCommunicationStyle || undefined,

        // Lifestyle - flatten for component compatibility
        workLifeBalance: (existingProfile.lifestylePriorities as any)
          ?.workLifeBalance,
        socialEnergyLevel: (existingProfile.lifestylePriorities as any)
          ?.socialEnergyLevel,
        hobbiesAndInterests: (existingProfile.lifestylePriorities as any)
          ?.hobbiesAndInterests,
        lifestylePriorities:
          (existingProfile.lifestylePriorities as any) || undefined,

        // Self-reflection - flatten for component compatibility
        friendsDescription: (existingProfile.selfReflection as any)
          ?.friendsDescription,
        proudestMoment: (existingProfile.selfReflection as any)?.proudestMoment,
        biggestGrowthArea: (existingProfile.selfReflection as any)
          ?.biggestGrowthArea,
        personalStrengths: (existingProfile.selfReflection as any)
          ?.personalStrengths,
        areasForImprovement: (existingProfile.selfReflection as any)
          ?.areasForImprovement,
        selfReflection: (existingProfile.selfReflection as any) || undefined,

        // Legacy compatibility
        currentChallenges: existingProfile.currentChallenges?.length
          ? existingProfile.currentChallenges
          : undefined,
        personalityTraits:
          (existingProfile.personalityTraits as any) || undefined,
      });
    ...
    if (currentStep < STEPS.length - 1) {
      ...
      if (hasEnhancedData) {
        ...
        const enhancedData = {
          ...
          preferredCommunicationStyle:
            assessmentData.preferredCommunicationStyle!,
          ...
          relationshipHistory:
            assessmentData.hasSignificantPast !== undefined
              ? {
                  hasSignificantPast: assessmentData.hasSignificantPast,
                  lastRelationshipDuration:
                    assessmentData.lastRelationshipDuration,
                  timeSinceLastRelationship:
                    assessmentData.timeSinceLastRelationship,
        ...
        <Card className="mb-6">
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle>
                  {isEditMode ? t("editProfileTitle") : t("profileTitle")}
                </CardTitle>
                <CardDescription>
                  {isEditMode
            ...
            {CurrentStepComponent && (
              <CurrentStepComponent
                ...
                isLoading={
                  ...
                  submitEnhancedAssessment.isPending ||
